...
do {
    ...
    _ = try run(["xcodebuild", "-project", "chapter04-using-content-configuration/chapter04-using-content-configuration.xcodeproj", "-scheme", "chapter04-using-content-configuration",
